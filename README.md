...
O plano de implementação está em [`docs/PLAN.md`](docs/PLAN.md). A arquitetura está em [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md). A configuração está em [`docs/CONFIGURATION.md`](docs/CONFIGURATION.md). A exposição do API Server está em [`docs/INFRASTRUCTURE.md`](docs/INFRASTRUCTURE.md). A configuração do módulo Waybar está em [`docs/WAYBAR.md`](docs/WAYBAR.md).
